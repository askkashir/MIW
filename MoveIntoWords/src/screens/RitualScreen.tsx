...
const TIME_SLOTS = [
  { id: 'morning', label: 'Morning', sublabel: '(before 10am)', icon: 'cloud' },
  { id: 'midday',  label: 'Midday',  sublabel: '(10am - 3pm)',  icon: 'sunny' },
  { id: 'evening', label: 'Evening', sublabel: '(3pm - 7pm)',   icon: 'cafe' },
  { id: 'night',   label: 'Night',   sublabel: '(after 7pm)',   icon: 'moon' },
] as const;
