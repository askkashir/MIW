  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Crisis Resources</Text>
        <View style={{ width: 40 }} />
      </View>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Text style={[styles.intro, { color: colors.textSecondary }]}>If you or someone you know is in crisis, please reach out. You are not alone.</Text>
        {RESOURCES.map((r) => (
          <Pressable key={r.name} style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]} onPress={() => Linking.openURL(r.url)}>
            ...
            <View style={styles.cardContent}>
              ...
              <Text style={[styles.cardContact, { color: colors.textSecondary }]}>{r.contact}</Text>
            </View>
