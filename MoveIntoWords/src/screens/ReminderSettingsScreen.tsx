  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Reminder Notifications</Text>
      ...
      <View style={styles.section}>
        <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <View style={styles.listItem}>
            ...
            <Text style={[styles.listText, { color: colors.textPrimary }]}>Daily Reminder</Text>
            <Switch
          ...
          <Pressable style={styles.listItem} onPress={() => setTimeModalVisible(true)}>
            ...
            <Text style={[styles.listText, { color: colors.textPrimary }]}>Reminder Time</Text>
            <Text style={[styles.listValue, { color: colors.textSecondary }]}>{time}</Text>
      ...
      >
        <Pressable style={styles.modalOverlay} onPress={() => setTimeModalVisible(false)}>
          <Pressable style={styles.modalCard} onPress={() => {}}>
            <Text style={[styles.modalTitle, { color: colors.textPrimary }]}>Select a time</Text>
            <FlatList
              data={[...TIME_OPTIONS]}
