...
export const ColorSchemes: Record<ThemeName, ThemeColors> = {
  light: Colors,
  dark: {
    ...Colors,
    primary: '#B56A78',
    ...
    surface: '#241B1E',
    surfaceDark: '#382B2D',
    surfaceDarker: '#120D0F',
    textPrimary: '#F7F0F2',
    textSecondary: '#C9B8BD',
    textPlaceholder: '#8E7D82',
    inputBackground: '#21191C',
    border: '#3C2D31',
    borderFocused: '#F0B3BD',
    dotInactive: '#4B383D',
    journalBlueLight: '#293A44',
    journalGreenLight: '#263A2D',
